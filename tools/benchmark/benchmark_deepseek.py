# tools/benchmark/benchmark_deepseek.py
"""
Script simplifié pour lancer directement un benchmark avec DeepSeek optimisé (deepseek-tests).
"""
import sys
...
def main():
    ...
    model = "deepseek-tests"  # modèle optimisé créé avec le Modelfile
    print(f"=== Benchmark DeepSeek optimisé ({model}) ===\n")
